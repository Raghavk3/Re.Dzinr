...
export const ui = {
	en: {
		...
		homepage: "Homepage",
		tagline:
			"We exist to bridge the gap between 'what is' and 'what could be'. We take the raw essence of your vision and refine it through the lens of a creative designer. We aren't just building websites or managing feeds, we are weaving a digital spell that transforms brands into icons, using a blend of data driven logic and pure creative magic.",
		...
		"hero.title.3": "Videos",
		"hero.title.4": "Brands",
		"hero.title.5": "Campaigns",
		"hero.subtitle":
			"Our digital agency specializes in crafting captivating websites and designs that convert and sell. Contact us for a free consultation.",
		"hero.scroll": "scroll down to explore more",
		"websites.title": "Websites",
		"uiux.title": "UI/UX Design",
		"apps.title": "Graphic Designing",
		"seo.title": "Video Editing",
		"advertising.title": "Marketing and Branding",
		"websites.content": "At Re.Dzinr, we specialize in crafting bespoke websites tailored to your brand's needs. Our approach combines aesthetic design with technical proficiency, ensuring your site is visually stunning, fast, and responsive across all devices.",
		...
		"apps.content": "We deliver top-tier graphic design services, focused on creating visually compelling, cohesive, and impactful designs. From branding and marketing materials to digital and print assets, our designs are crafted to strengthen brand identity, engage audiences, and drive business growth.",
		"seo.content": "Re.Dzinr’s video editing services are crafted to captivate audiences and elevate your brand’s visual storytelling. We create high-impact social media and advertising edits using premium software like Adobe After Effects, combining creative precision with modern techniques to produce engaging, polished, and performance-driven video content.",
		"advertising.content": "Our advertising services aim to maximize your ROI through targeted and effective ad campaigns. We specialize in creating compelling ad content and strategies that resonate with your audience, utilizing various platforms like Meta Ads and social media to enhance your brand's reach and engagement.",
		...
		"contact.send": "Send",
		"blog.title": "About Us",
		"blog.subtitle": "Who we are and what we do",
	...
	it: {
		...
		"websites.content": "Da Re.Dzinr, siamo specializzati nella realizzazione di siti web su misura per le esigenze del tuo marchio. Il nostro approccio combina design estetico con competenza tecnica, garantendo che il tuo sito sia visivamente accattivante, veloce e reattivo su tutti i dispositivi.",
